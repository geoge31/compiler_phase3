...
expr:               
                    ...
                    |expr NOT_EQUAL expr {
                        ...
                        emit(if_noteq,$1,$3,$$,nextQuadLabel(),yylineno);
                    ...
                    |expr AND M expr {
                        ...
                        emit(if_eq,$1,$4,$$,nextQuadLabel()+3,yylineno);
                        emit(jump,NULL,NULL,NULL,nextQuadLabel()+2,yylineno);

                        $$->falselist=newList(nextQuadLabel()); 
...
ifprefix:           
                      IF LEFT_PARENTHESIS expr RIGHT_PARENTHESIS {
                        ...
                        lists* tl=newList(nextQuadLabel()+3);
                        backpatch($3->truelist,tl->q_quad);

                        emit(if_eq,$3,newExpr_constBool(1),NULL,tl->q_quad,yylineno);
                        $$=nextQuadLabel();
                        emit(jump,NULL,NULL,NULL,nextQuadLabel(),yylineno);
